...
def read_output_prob_t2(j,resulting_file_name,patients_folder):
	    ...
	    if(os.path.isfile(BSN_output_folder+'/g4t1_-1-stdout.log')):
	       with open(BSN_output_folder+'/g4t1_-1-stdout.log') as f:
		    ...
		    for line in f:
		        ...
		        if(line.startswith("Oxi activate!!!!!!!!!!!!!!!!!!!!")):
		        	    oxi_act=1
		        if(line.startswith("Oxi deactivate!!!!!!!!!!!!!!!!!!!!")):
		        	    oxi_act=0
		        if(line.startswith("Ecg activate!!!!!!!!!!!!!!!!!!!!")):
		        	    ecg_act=1
		        if(line.startswith("Ecg deactivate!!!!!!!!!!!!!!!!!!!!")):
		        	    ecg_act=0
		        if(line.startswith("Trm activate!!!!!!!!!!!!!!!!!!!!")):
		        	    term_act=1
		        if(line.startswith("Trm deactivate!!!!!!!!!!!!!!!!!!!!")):
		        	    term_act=0
		        if(line.startswith("Abps activate!!!!!!!!!!!!!!!!!!!!")):
		        	    abps_act=1
		        if(line.startswith("Abps deactivate!!!!!!!!!!!!!!!!!!!!")):
		        	    abps_act=0
		        if(line.startswith("Abpd activate!!!!!!!!!!!!!!!!!!!!")):
		        	    abpd_act=1
		        if(line.startswith("Abpd deactivate!!!!!!!!!!!!!!!!!!!!")):
		        	    abpd_act=0
		        if(line.startswith("Glc activate!!!!!!!!!!!!!!!!!!!!")):
		        	    glc_act=1
		        if(line.startswith("Glc deactivate!!!!!!!!!!!!!!!!!!!!")):
		        	    glc_act=0
		        #print(str(oxi_act)+" "+str(ecg_act)+" "+str(term_act)+" "+str(abps_act)+" "+str(abpd_act)+" "+str(glc_act))
		        ...
		        if(line.startswith("++++++++++++++++++++")):
				        ...
				        if(term_act==0 or ini_state_term==0):
					    term="deactivated"
				        if(ecg_act==0 or ini_state_ecg==0):
					    ecg="deactivated"
				        if(oxi_act==0 or ini_state_oxi==0):
				 	    oxi="deactivated"
				        if(abps_act==0 or ini_state_abps==0):
					    abps="deactivated"
				        if(abpd_act==0 or ini_state_abpd==0):
					    abpd="deactivated"
				        if(glc_act==0 or ini_state_glc==0):
					    glc="deactivated"
    ...
    #workbook.save("./output"+str(j)+"_"+resulting_file_name)
