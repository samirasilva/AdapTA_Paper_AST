...
def main(argv): 
	# Sample data S1
	scenario="Scenario 1"
	sample1 = [89.46, 84.17, 90.46, 89.75, 89.53]#baseline
	sample2 = [73.3, 68.12, 69.35, 59.12, 77.30]#adapta
	compute(sample1,sample2,scenario)
	
	# Sample data S2
	scenario="Scenario 2"
	sample1 = [92.22,90.72,89.68,84.33,90.92]#baseline
	sample2 = [72.16,82.57,73.36,66.13,68.23]#adapta
	compute(sample1,sample2,scenario)

	# Sample data S3
	scenario="Scenario 3"
	sample1 = [86.29,89.77,88.83,86.85,88.50]#baseline
	sample2 = [56.76,65.65,61.98,63.78,59.04]#adapta
	compute(sample1,sample2,scenario)
